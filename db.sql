...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2020 at 12:56 AM
...
--
-- Constraints for table `tailors_order`
--
ALTER TABLE `tailors_order`
  ADD CONSTRAINT `tailors_order_ibfk_1` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`);
